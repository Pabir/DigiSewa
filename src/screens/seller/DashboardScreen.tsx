...
export const DashboardScreen: React.FC<DashboardScreenProps> = ({
  ...
  const handleSelectSidebarTab = (tab: string) => {
    setActiveTab(tab);
    if (tab === 'inventory' && onNavigateToManageCatalogs) {
      onNavigateToManageCatalogs();
    } else if (tab === 'orders') {
      onNavigateToOrders();
    }
    ...
    return (
      <ScrollView style={styles.container} contentContainerStyle={styles.contentContainer}>
        ...
        <View style={styles.quickActionsRow}>
          <TouchableOpacity style={styles.quickActionCard} onPress={onNavigateToAddProduct}>
            ...
            <Text style={styles.actionSubtitle}>Clothing, Waist/Chest sizes & prices</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.quickActionCard} onPress={onNavigateToManageCatalogs}>
            ...
            <Text style={styles.actionSubtitle}>Update waist inches & stock per size</Text>
          </TouchableOpacity>
        ...
        <View style={[styles.metricsGrid, isDesktop && styles.metricsGridDesktop]}>
          <View style={[styles.metricCard, isDesktop ? styles.metricColDesktop : styles.metricColMobile]}>
            ...
            <View style={styles.growthRow}>
              ...
              <Text style={styles.growthText}>+18.4% this month</Text>
            </View>
          </View>
